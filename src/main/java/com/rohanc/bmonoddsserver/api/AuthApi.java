...
public interface AuthApi {
	 ...
	 */
	@Operation(operationId = "getUserSession", summary = "Get current logged-in user.", tags = { "user",
			"auth" }, responses = {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/api/auth/session", produces = { "application/json" })
	 ...
	 * @return
	 */
	@Operation(operationId = "login", summary = "Logs the user in", tags = { "user", "auth" }, responses = {
	})
	@RequestMapping(method = RequestMethod.POST, value = "/api/auth/login", consumes = {
	 ...
	 */
	@Operation(operationId = "register", summary = "register a new user.", tags = { "user", "auth" }, responses = {
			@ApiResponse(responseCode = "200", description = "a user is logged in and was returned.", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = UserDto.class))
			}),
	...
	@RequestMapping(method = RequestMethod.POST, value = "/api/auth/register", produces = {
