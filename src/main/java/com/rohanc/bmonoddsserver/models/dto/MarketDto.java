...
public class MarketDto implements Serializable {
   ...
   */
  public MarketDto(Long id, String name) {
    this.id = id;
    this.name = name;
  }

  public MarketDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public MarketDto createdAt(OffsetDateTime createdAt) {
  ...
  public MarketDto updatedAt(OffsetDateTime updatedAt) {
  ...
  public MarketDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, marketDto.id)
        && Objects.equals(this.createdAt, marketDto.createdAt)
        && Objects.equals(this.updatedAt, marketDto.updatedAt)
        && Objects.equals(this.name, marketDto.name);
  }
